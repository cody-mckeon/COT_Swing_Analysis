...
def merge_cot_with_price(
    ...
    price["report_date"] = pd.to_datetime(price["date"], errors="coerce", utc=True)
    # remove timezone information to align with COT dates
    price["report_date"] = price["report_date"].dt.tz_localize(None)
